            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body" v-if="product.image">
                        <img id="previewImage" :src="ImageURL+product.image" class="img-thumbnail img-fluid">
                    </div>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            updateProduct () {
                ...
                axios.post(this.Api.product+"/"+this.$route.params.id, postData, { headers: this.$globalHelper.authHeader(), config })
            ...
            getProduct() {
                axios.get(this.Api.product+"/"+this.$route.params.id, { headers: this.$globalHelper.authHeader() })
                    .then((response) => response.data)
                    .then((response) => {
                        if (response.status === true) {
